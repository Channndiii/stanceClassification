...
if __name__ == '__main__':
    ...
    USE_GPU = True
    with open('./data/data_create_debate_train_64.pkl', 'rb') as fr:
    ...
    with open('./data/data_create_debate_test_64.pkl', 'rb') as fr:
    ...
    for type in ['hybrid']:  # gpu:2
        ...
        for i in range(cv_times):
            # with open('./result_log/create_debate_%s_%s.txt' % (type, i), 'w') as fw:
            with open('./result_log/create_debate_preTrain_%s_%s.txt' % (type, i), 'w') as fw:
